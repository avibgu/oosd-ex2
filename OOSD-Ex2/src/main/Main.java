...
public class Main extends JPanel {
	...
	public Main() {
	    ...
	    String[] listEnrties1 = {"enrty_1","enrty_2","enrty_3"};
	    JList list = new JList(listEnrties1);
	    add(list, tConst);


		// (1,3-4) List of titles
		tConst = (GridBagConstraints)tListConst.clone();
		tConst.fill = BOTH;
		tConst.gridx = 2; tConst.gridy = 3;
		tConst.gridwidth = 5; tConst.gridheight = 4;

		String[] listEnrties2 = {"enrty_1","enrty_2","enrty_3"};
	...
	public static void main(String[] args) {
		...
		tFrame.setContentPane(new Main());
		tFrame.pack();
